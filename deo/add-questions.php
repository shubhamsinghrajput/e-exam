...
<body id="page-top" class="pd-fix" style="background: grey">
    <?php include 'nav.php';?>
                ...
                <div class="col-lg-12 border-top-0">                   
                   <div class="col-lg-6">
                       ...
                       <div class="form-group row">                         
                           ...
                           <div class="form-group row">
                           <div class="col-12">
                               <input class="form-control" type="text" placeholder="Please Enter Question Here">
                           </div>
                           
                           <label class="col-1 col-form-label form-control-label">A</label>
                           <div class="col-11">
                               <input class="form-control" type="text" placeholder="Option A">
                           </div>
                           
                           <label class="col-1 col-form-label form-control-label">B</label>
                           <div class="col-11">
                               <input class="form-control" type="text" placeholder="Option B">
                           </div>
                           
                           <label class="col-1 col-form-label form-control-label">C</label>
                           <div class="col-11">
                               <input class="form-control" type="text" placeholder="Option C">
                           </div>
                           
                           <label class="col-1 col-form-label form-control-label">D</label>
                           <div class="col-11">
                               <input class="form-control" type="text" placeholder="Option D">
                           </div>
                       </div>
                   </div>
