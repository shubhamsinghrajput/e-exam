                                ...
                                <div class="container-fluid mt-3">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div id="task_description" class="tab-pane fade ml-4 mr-4"><br>
                                            <div class="row">
                                                <label for="description" class="col-form-label">Provide a detailed description for this task (optional)</label>
                                                <textarea name="taskDescription" rows="4" id="taskDescription" name="taskDescription" style="width:100%"></textarea>
                                            </div>
                                        </div>
                                               ...
                                               <div class="row">
                                                ...
                                                <div class="btn-group" data-toggle="buttons">
                                                    <label class="btn btn-dark mr-2">
                                                        <input type="radio" name="options" id="none"> None
                                                    </label>
                                                    <label class="btn btn-success mr-2">
                                                        <input type="radio" name="options" id="low"> Low
                                                    </label>
                                                    <label class="btn btn-warning mr-2">
                                                        <input type="radio" name="options" id="medium"> Medium
                                                    </label>
                                                    <label class="btn btn-danger mr-2">
                                                        <input type="radio" name="options" id="high"> High
                                                    </label>
                                                </div>
                                        </div>
                                        <div id="followers" class="tab-pane fade ml-4 mr-4"><br>
                                            <div class="row">
                                                <label for="description" class="col-form-label">Privacy — Who can see this task?</label>
                                                <div class="input-group">
                                                    <input type="text" class="form-control" placeholder="Search existing users..." aria-label="Search existing users...">
                                                    <div class="input-group-append">
                                                        <span class="input-group-text"><i class="fa fa-search" aria-hidden="true"></i></span>
